...
public class Order {
	...
	//Costruttore ordini per storico
	
	public Order(Cart cart, Payment payment, String paymentInfo, String address,LocalDate date, OrderDeliveryTime time,User user, HashMap<Integer,Float> prices) {
		this.cart=cart;
		this.payment=payment;
		this.paymentInfo=paymentInfo;
		this.address=address;
