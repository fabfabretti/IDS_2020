 ...
 * @author Fabiola
 * 
 *         E' la classe che definisce gli utenti. Mi aspetto che sarà una classe
 *         astratta con i metodi
 * @method getEmail
 * @method getPassword
 * 
 *         Ogni altro metodo (per esempio il costruttore o altri get, come
 *         getCarrello) sarà definito nelle sue sottoclassi (presumibilmente
 *         Utente e Commesso)
 */
public class UserGeneral {
	 ...
	 * @return ritorna "null" se questo utente NON corrisponde al login; "commesso"
	 *         se corrisponde ed è un commesso; "utente" se corrisponde ed è un
	 *         utente
	 * 
	 */
	...
	/**
	 * 
	 * @author andreatoffaletti Informazioni relative all'anagrafica di un User
	 *         generico.
	 */
